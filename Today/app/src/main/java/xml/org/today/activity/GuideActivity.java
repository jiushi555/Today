...
public class GuideActivity extends Activity implements  OnPageChangeListener{
	...
	private int[] mImageIds = new int[] { R.mipmap.guide_1,
			R.mipmap.guides_2_, R.mipmap.guides_3_ };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.btn_go_login).setOnClickListener(new OnClickListener() {
			@Override
		...
		findViewById(R.id.btn_go_register).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
