...
import xml.org.today.util.CropImage;
import xml.org.today.util.CropImageView;
...
public class CropImageActivity extends Activity implements OnClickListener{
    ...
    private void init()
    {
        ...
        rotateLeft = (ImageButton) this.findViewById(R.id.gl_modify_avatar_rotate_left);
        rotateRight = (ImageButton) this.findViewById(R.id.gl_modify_avatar_rotate_right);
